...
// Project           - ArduinoUno-FingerprintSensor-based-Locker
...
static int16_t relayPin1 = 7;         // Solenoid Lock connected to these relays
static int16_t relayPin2 = 8;
...
void openLocker1(){
digitalWrite(relayPin1, LOW);              // inverted logic for relay activation
delay(5000);                               // delay for keeping lock open for only 5 Seconds
}
